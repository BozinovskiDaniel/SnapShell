...
const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate }: { shippingAddress: ShippingAddress, orderId: string, orderDate: string }) => {
  ...
  const baseURL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://snap-shell.vercel.app"
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We're preparing everything for delivery and will notify you once your package has been shipped. Delivery usually takes 2-3 days.
            </Text>
          ...
          <Section style={paddingY}>
            ...
            <Row>
              <Text style={footer.text}>
                © 2024 SnapShell, Inc. All rights reserved.
              </Text>
            </Row>
          </Section>
