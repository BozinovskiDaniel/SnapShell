        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              We at SnapShell believe that a phone case doesn't only need to look good, but also
              last your for the years to come. We offer a 5-year print guarantee: if your case isn't
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm">
            ...
            <div>
              ...
              <p className="mt-2 text-zinc-700">AusPost, takes up to 3 working days.</p>
            </div>
          </div>
