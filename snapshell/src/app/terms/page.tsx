        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p>
              ...
              may opt out of receiving any, or all, of these communications from us by following the
              unsubscribe link or by emailing at BozinovskiDaniel@hotmail.com.
            </p>
          </div>
          <div className="mb-8">
          ...
          <div className="mb-8">
            ...
            <p>
              ...
              Terms. If you participate in any Promotions, please review the applicable rules as
          ...
          <div className="mb-8">
            ...
            <p>
              In no event shall SnapShell, nor its directors, employees, partners, agents,
